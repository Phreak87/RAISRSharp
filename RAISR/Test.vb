...
Class test
    ...
    Sub New()
        ...
        For Each image In imagelist
            ...
            Dim ycrcvorigin As Mat : Emgu.CV.CvInvoke.CvtColor(origin, ycrcvorigin, CvEnum.ColorConversion.Bgr2YCrCb)

            Dim grayorigin As Mat = ycrcvorigin(":", ":", 0)
...
Class Pickle
    Shared Function Load(Path As String)
        My.Computer.FileSystem.ReadAllBytes(Path)
    End Function
End Class