...
#End Region
    ...
    End Function
    Shared Function linspace(Start As Double, Ends As Double, Cnt As Integer) As Single()
    ...
    Shared Function Diag(A As Double(), Optional k As Double = 0) As Double()()
        Dim Res As New List(Of Double())
        If k = 0 Then
            For i As Integer = 0 To A.Count - 1
    ...
    Shared Function interp2d(a, b, c, kind) As Object
