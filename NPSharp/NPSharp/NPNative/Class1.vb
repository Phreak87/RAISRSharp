...
#Region "Zeros"
    Shared Function Zeros(ByVal Count As Integer) As Double()
...
#End Region
    ...
    End Function
    Shared Function linspace(ByVal a As Integer, ByVal b As Integer, ByVal c As Integer)
